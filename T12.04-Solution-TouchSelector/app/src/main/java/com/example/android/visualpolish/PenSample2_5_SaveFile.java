...
import com.example.android.visualpolish.tool.SDKUtils;
import com.example.android.visualpolish.tool.ShapeAdapter;
...
public class PenSample2_5_SaveFile extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap bitmap = BitmapFactory.decodeFile(intent.getStringExtra("data"), options);
...
//        textInfo.size = Math.round(18 * mCanvasWidth / 360);
    ...
    private void updatePropertiesDiablogLayout() {
        ...
        if (400 * (metrics.densityDpi / 160f) > mScreenHeight) {
            params.height = mScreenHeight - 200;
