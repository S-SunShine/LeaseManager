...
app.get('/', function (req, res) {
  ...
  res.send('recorded on blockchain');
  sendTx(memo);
})

app.listen(3000);

function sendTx(memo) {
...
var sourceSecretKey = 'SD2MCL66642MEUP2KUXRECVE5JS2WZVYZ753F2OYZ2WZTV3JIDFHE5J5';
